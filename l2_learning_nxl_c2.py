...
class l2_learning (object):
  ...
  def __init__ (self, transparent, ignore = None):
    ...
    self.channelRabbitmq.queue_declare(queue='queue_1', durable=True)
  ...
  def subscriber(self):
    ...
    channel.basic_consume(callback,queue='queue_2')
  ...
  def controller_failover(self, pub_conn):
    ...
    self.connectdb()
    sql = ("Select s_name, c_name from sdn_link where c_name = 'poxController'")
